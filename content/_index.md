...
I really love Python 🐍 and write any kind of programs and scripts like Crawlers, Bots (for Telegram, Instagram), GUI applications (using PyQt), Websites and API's (using Flask, Django, Channels) in it. I also code in Node.js, Lua and some another languages (sometimes by need) and know HTML and CSS well.
